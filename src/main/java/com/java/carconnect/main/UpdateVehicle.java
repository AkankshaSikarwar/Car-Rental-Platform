		...
		try {
			...
			while(isInvalidVehicleId)
			{
				...
				if(isValidVehicle==null) {
					...
					System.out.println(RED+"No matching Vehicle Id found. Please enter a valid Vehicle"
							+ " Id."+RESET);
				}
				else
				{
...
//					vehicle.setRegistrationNumber(isValidVehicle.getRegistrationNumber());
					...
					while(isInvalidRegistrationNumber)
					{
						...
						if(isValidVehicle!=null) {
							...
							System.out.println(RED+"Registration Number already exists. Please"
									+ " enter a valid Registration Number."+RESET);
						}
						else {
